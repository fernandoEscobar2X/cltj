...
export default function ContactSection() {
  return (
    <section id="contacto" className="relative min-h-[85vh] flex items-end pb-20 pt-32 bg-[#050505] overflow-hidden border-t-[3px] border-[var(--ink)]">
      ...
      <div className="layout-shell relative z-10 w-full flex flex-col md:flex-row justify-between items-start md:items-end gap-12">
        
        {/* Left side: Massive typography */}
        <div className="flex-1">
          <h2 className="text-[5.5rem] md:text-[8rem] lg:text-[11rem] font-black leading-[0.8] tracking-tighter text-white mb-8 md:mb-12">
            HAGAMOS
